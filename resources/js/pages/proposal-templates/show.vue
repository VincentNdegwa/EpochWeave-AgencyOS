...
<template>
    ...
    <div class="relative -mx-4 -mb-4 h-[calc(100vh-64px)]">
        <ProposalCanvas :is-locked="true" :builder-mode="'template'" />

        <div class="fixed right-6 bottom-6 z-50">
            <Link
                :href="proposalTemplates.edit(template.id)"
                class="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-medium shadow-lg transition-colors"
            >
                <Edit class="h-4 w-4" />
                Edit Template
            </Link>
