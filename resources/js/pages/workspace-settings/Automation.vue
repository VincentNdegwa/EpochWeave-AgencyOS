...
import { MailIcon, SparklesIcon } from '@lucide/vue';
...
const automationToggles = [
    {
        ...
        description:
            'Automatically draft and link a structural invoice when a proposal is signed',
    ...
    },
    {
        ...
        description:
            'Instantly provision a new workspace project board upon client sign-off',
