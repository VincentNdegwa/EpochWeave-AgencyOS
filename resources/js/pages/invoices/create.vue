...
return;
    ...
    try {
        await router.post(InvoiceController.store().url, form.value as any, {
            onError: (pageErrors) => {
...
const goBack = () => {
    router.visit(InvoiceController.index().url);
};
...
<template>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h4 class="font-bold tracking-tight">Create Invoice</h4>
                <p class="text-muted-foreground">
                    Create a new invoice with line items for your client.
                </p>
            </div>
