...
<template>
    <div v-if="data" class="flex flex-col gap-0 text-sm">
        ...
        <div class="py-3">
            ...
            >
                <div
                    class="border-b border-dashed border-border/60 bg-background/50 px-3 py-1 text-[11px] text-muted-foreground"
                >
                    Canvas preview
                </div>
                <div class="px-4 py-2">
                    <div
                        class="w-full rounded bg-muted/50"
                        :style="{ height: `${data.height_px}px` }"
                    />
                </div>
            </div>
        </div>
