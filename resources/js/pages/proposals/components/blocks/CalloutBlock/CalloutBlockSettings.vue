        ...
        <div class="border-b border-border py-3">
            ...
            <div class="grid grid-cols-3 gap-1.5">
                <button
                    ...
                    :class="
                        preset.bg && data.background_color === preset.bg
            ...
            <div class="space-y-4">
                <div class="grid gap-1.5">
                    ...
                    <ColorPresets
                        ...
                        @update:model-value="
                            (v) => updateData({ background_color: v })
                        "
                    />
                </div>
            ...
            >
                ...
                >
                    ...
                    <Switch
                        ...
                        @update:model-value="
                            (v: boolean) => updateData({ border_left: v })
                        "
                    />
                </label>
            </div>
