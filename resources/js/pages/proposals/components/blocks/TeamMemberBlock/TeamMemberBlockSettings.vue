...
const { data, updateData } = useBlockSettings<TeamMemberBlockData>(
    props.blockId,
);
</script>
        ...
        <div class="py-3">
            ...
            <div class="grid grid-cols-2 gap-1.5">
                <button
                    ...
                    @click="
                        updateData({
                            layout: opt.value as TeamMemberBlockData['layout'],
                        })
                    "
                >
                    <!-- Mini preview -->
                    ...
                    <div v-else class="flex w-16 flex-col gap-1">
                        <div
                            v-for="n in 2"
                            :key="n"
