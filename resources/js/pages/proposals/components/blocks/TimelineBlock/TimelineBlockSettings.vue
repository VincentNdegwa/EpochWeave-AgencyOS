        ...
        <div class="py-3">
            ...
            <div class="grid grid-cols-2 gap-1.5">
                <button
                    v-for="opt in [
                        {
                            value: 'vertical',
                            label: 'Vertical',
                            hint: 'Stacked top to bottom',
                        },
                        {
                            value: 'horizontal',
                            label: 'Horizontal',
                            hint: 'Left to right flow',
                        },
                    ]"
                    :key="opt.value"
                    type="button"
                    ...
                    @click="
                        updateData({
                            layout: opt.value as TimelineBlockData['layout'],
                        })
                    "
                >
                    <!-- Icon preview -->
            ...
            <p class="mt-3 text-[11px] text-muted-foreground">
                Edit milestones directly on the canvas — click any field to
                update it.
            </p>
        </div>
    </div>
