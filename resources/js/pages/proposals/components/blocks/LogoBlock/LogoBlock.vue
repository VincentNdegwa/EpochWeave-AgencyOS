...
<template>
  <section class="px-8 py-4">
    <div class="flex items-center gap-8" :class="alignClass">
      ...
      <!-- Workspace logo -->
      <template v-if="data.layout === 'workspace_only' || data.layout === 'both_side_by_side'">
        <img
        ...
        >
          ...
          <span class="text-xs text-muted-foreground">Workspace logo</span>
        </div>
      </template>
      ...
      <!-- Client logo -->
      <template v-if="data.layout === 'client_only' || data.layout === 'both_side_by_side'">
        <img
        ...
        >
          <BuildingIcon class="h-4 w-4 text-muted-foreground" />
          <span class="text-xs text-muted-foreground">Client logo</span>
        </div>
      </template>
