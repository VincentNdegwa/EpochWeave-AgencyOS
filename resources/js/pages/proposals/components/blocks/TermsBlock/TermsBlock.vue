...
<template>
    <section class="px-8 py-6">
        ...
        <div
            v-else
            class="ql-editor prose prose-sm max-w-none leading-relaxed text-foreground [&_h1]:mb-3 [&_h1]:text-xl [&_h1]:font-bold [&_h2]:mb-2 [&_h2]:text-lg [&_h2]:font-semibold [&_h3]:mb-2 [&_h3]:text-base [&_h3]:font-semibold [&_ol]:mb-3 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-3 [&_strong]:font-semibold [&_ul]:mb-3 [&_ul]:list-disc [&_ul]:pl-5"
            v-html="
                data.content ||
                '<p class=\'text-muted-foreground italic\'>No terms added.</p>'
            "
        />
    </section>
</template>
