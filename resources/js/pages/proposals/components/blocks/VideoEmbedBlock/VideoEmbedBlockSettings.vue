...
const { data, updateData } = useBlockSettings<VideoEmbedBlockData>(
    props.blockId,
);
    ...
    <div v-if="data" class="flex flex-col gap-0 text-sm">
        ...
        <div class="py-3">
            ...
            <div class="space-y-3">
                <div class="grid gap-1.5">
                    <Label class="text-xs text-muted-foreground"
                        >Title <span class="opacity-50">(optional)</span></Label
                    >
                    <Input
                ...
                <div class="grid gap-1.5">
                    ...
                    <Input
                        ...
                        class="h-8 text-xs"
                        @update:model-value="
                            (v) => updateData({ caption: v ? String(v) : null })
                        "
                    />
                </div>
            </div>
