...
const paddingBottom = computed(
    () => `${paddingScale[props.meta.padding_bottom]}px`,
);
...
const isHiddenInPreview = computed(
    () => props.isLocked && props.meta.is_hidden,
);
const isHiddenInEditor = computed(
    () => !props.isLocked && props.meta.is_hidden,
);
</script>
...
<template>
    ...
    >
        ...
        <div
            ...
            class="pointer-events-none absolute inset-0 flex items-center justify-center bg-background/60 text-center text-xs font-medium text-muted-foreground backdrop-blur-sm"
        >
